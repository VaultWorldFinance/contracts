...
// File: @vaultworld/matrixswap-lib/contracts/token/BEP20/IBEP20.sol
...
// File: contracts/VaultWorldProfile.sol

pragma solidity ^0.6.0;

/** @title VaultWorldProfile.
@dev It is a contract for users to bind their address 
to a customizable profile by depositing a NFT.
*/
contract VaultWorldProfile is AccessControl, ERC721Holder {
